...
Route::middleware(['auth', 'verified', \App\Http\Middleware\AdminMiddleware::class])->get('/admin/reports/scheduled', [\App\Http\Controllers\AdminReportController::class, 'scheduledReports'])->name('admin.reports.scheduled');
Route::middleware(['auth', 'verified', \App\Http\Middleware\AdminMiddleware::class])->delete('/admin/reports/scheduled/bulk-delete', [\App\Http\Controllers\AdminReportController::class, 'bulkDeleteScheduledReports'])->name('admin.reports.scheduled.bulkDelete');
Route::middleware(['auth', 'verified', \App\Http\Middleware\AdminMiddleware::class])->get('/admin/reports/scheduled/create', [\App\Http\Controllers\AdminReportController::class, 'createScheduledReport'])->name('admin.reports.scheduled.create');
Route::middleware(['auth', 'verified', \App\Http\Middleware\AdminMiddleware::class])->post('/admin/reports/scheduled', [\App\Http\Controllers\AdminReportController::class, 'storeScheduledReport'])->name('admin.reports.scheduled.store');
Route::middleware(['auth', 'verified', \App\Http\Middleware\AdminMiddleware::class])->post('/admin/reports/scheduled/{id}/run-now', [\App\Http\Controllers\AdminReportController::class, 'runScheduledReportNow'])->name('admin.reports.scheduled.runNow');
