    ...
    <div class="vendor-form-card">
        ...
        <form action="{{ route('vendor-applicant.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="name" name="name" value="{{ old('name', $registrationData['name'] ?? '') }}" required>
            </div>
            <div class="mb-3">
                <label for="email" class="form-label">Email</label>
                <input type="email" class="form-control" id="email" name="email" value="{{ old('email', $registrationData['email'] ?? '') }}" required>
            </div>
            <div class="mb-3">
